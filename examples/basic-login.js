/**
 * basic-login.js — Basic login example for QuickBooks Desktop
...
async function main() {
  ...
  try {
    log('Starting QuickBooks Desktop automation (Open Source mode)');
    ...
    const result = await login_quickbooks(page, {
    ...
    // const data = await create_invoice(page, {});
    // log('Data:', data);
